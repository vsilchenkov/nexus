...
**В конце многоблочной сессии:** прогон полного `make test`, **ревизия всего diff'а** (см. выше —
без неё работу сдавать нельзя), проверка `git log` («все коммиты на месте, ничего не амеnд'нуто»),
и краткий итоговый отчёт пользователю с перечислением коммитов, найденного ревизией и ссылками на
