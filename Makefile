...
test-int-catalog: ## integration: каталоги/auth/сессии/нотификации/circuit-breaker
	$(GOTEST) -tags=integration -count=1 -v -timeout $(INTEGRATION_TIMEOUT) -run "^TestHostAllowlist|^TestHeaderCatalog|^TestLogMask|^TestAuth|^TestSession|^TestUserRole|^TestUserPrefs|^TestSearchHistory|^TestAppSettingsRepo|^TestNotif|^TestCircuitBreaker" ./tests/integration/...
