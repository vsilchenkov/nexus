...
| **§86: сквозной просмотр узлов всех команд («Все команды»)** | ✅ §86 | Раздел ТЗ [86-all-teams-scope.md](sections/86-all-teams-scope.md). Реализован целиком (Phase 86.1–86.12), слит в `dev`, выходит в 1.27.0. Миграций нет, Receiver и Sender не затронуты |
