...
- **55.6 Отчёт.** Шаги — как в §7.5.1; меняется «Response»: mock → синтетический 200 (50–100 мс,
...
- **55.7 Неочевидности.** Шаг «Auth (incoming)» ловит реальную ошибку «клиент шлёт креды не туда,
