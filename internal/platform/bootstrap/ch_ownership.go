...
// rebaseSeededTeamDB переименовывает БД сидированной команды под идентификатор
// ноды. Условия узкие намеренно: только первый запуск этой ноды (идентификатор
// заявлен нами, PostgreSQL свежая) и только пока имя равно сидированному.
//
// Если идентификатор задан, а условия не сошлись — это ошибка: молчаливое
