# Nexus: сто разделов технического задания

**8 сентября 2026 года в шину влит §100.** Сто разделов ТЗ — это сто законченных постановок:
от «Назначение» на четыре строки до развёртывания без простоя на двух репликах каждого сервиса.
Между первым коммитом и сотым разделом — 107 дней.
