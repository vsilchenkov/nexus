...
const docTemplate = `{
    ...
    "paths": {
        "/api/allowed-hosts": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "поиск по паттерну и описанию",
                        "name": "q",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "фильтр по типу: exact|wildcard|regex",
                        "name": "kind",
                        "in": "query"
                    },
                    {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_web_adapter_in_http.hostRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_web_adapter_in_http.hostPreviewRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/audit": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "смещение (legacy; для постраничного чтения используйте before_ts+before_id)",
                        "name": "offset",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "keyset-курсор §91.1: created_at последней показанной записи (RFC3339Nano). Работает только вместе с before_id",
                        "name": "before_ts",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "keyset-курсор §91.1: id последней показанной записи. Работает только вместе с before_ts",
                        "name": "before_id",
                        "in": "query"
                    }
                ],
        ...
        "/api/audit/count": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "all — журнал всех команд пользователя (§86.7)",
                        "name": "scope",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_web_adapter_in_http.AuditCountResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_web_adapter_in_http.headerRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/logs": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "all (дефолт) | csv из receiver,sender,web",
                        "name": "service",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "максимум записей (дефолт 500, кап 2000)",
                        "name": "limit",
                        "in": "query"
                    },
                    {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/nexus_internal_domain.ServiceLogEntry"
                            }
                        }
                    },
                    "400": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_web_adapter_in_http.diagnosticsDTO"
                        }
                    }
                }
            }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_web_adapter_in_http.attachHostRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/api/nodes/{id}/allowed-hosts/{host_id}": {
            "delete": {
                "security": [
                    {
                        "CookieAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_web_adapter_in_http.queueListDTO"
                        }
                    },
                    "404": {
                        "description": "Not Found",
        ...
        "/api/nodes/{id}/async-queue/messages/body": {
            "get": {
                "security": [
                    {
                        "CookieAuth": []
        ...
        "/api/nodes/{id}/async-queue/messages/{msgId}": {
            "delete": {
                "security": [
                    {
                        "CookieAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "message id (Envelope.ID)",
                        "name": "msgId",
                        "in": "path",
                        "required": true
                    }
                ...
                "responses": {
                    ...
                    "503": {
                        "description": "queue management unavailable",
                        "schema": {
                            "$ref": "#/definitions/internal_web_adapter_in_http.ErrorResponse"
                        }
                    }
        ...
        "/api/nodes/{id}/async-queue/purge": {
            "post": {
                "security": [
                    {
                        "CookieAuth": []
            ...
            "post": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/nexus_internal_web_usecase.SchemaSyncResult"
                        }
                    },
                    "404": {
                        "description": "Not Found",
        ...
        "/api/nodes/{id}/log/{logId}/body": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "смещение в рунах (default 0)",
                        "name": "offset",
                        "in": "query"
                    },
                    {
                        "type": "integer",
                        "description": "сколько рун вернуть (default 65536, max 4194304)",
                        "name": "limit",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_web_adapter_in_http.LogBodyChunkResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/api/nodes/{id}/log/{logId}/body/download": {
            "get": {
                "security": [
                    {
                        "CookieAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_web_adapter_in_http.ResolveTeamResponse"
                        }
                    },
                    "404": {
                        "description": "Not Found",
    ...
    "definitions": {
        ...
        "internal_web_adapter_in_http.AuditCountResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
        ...
        "internal_web_adapter_in_http.LogBodyChunkResponse": {
            "type": "object",
            "properties": {
                "chunk": {
                    "description": "сам срез",
                    "type": "string"
                },
                "eof": {
                    "description": "достигнут конец тела",
                    "type": "boolean"
                },
                "offset": {
                    "description": "смещение среза в рунах",
                    "type": "integer"
                },
                "returned": {
                    "description": "сколько рун в chunk",
                    "type": "integer"
                },
                "total": {
                    "description": "полная длина тела в рунах",
                    "type": "integer"
                },
                "which": {
                    "description": "request | response",
        ...
        "internal_web_adapter_in_http.NodesMetricsResponse": {
            ...
            "properties": {
                ...
                "totals": {
                    "description": "Totals — агрегат KPI шапки (§44.A): сумма строк items за тот же период.",
                    "allOf": [
                        {
        ...
        "internal_web_adapter_in_http.attachHostRequest": {
            "type": "object",
            "properties": {
                "host_id": {
                    "type": "string"
        ...
        "internal_web_adapter_in_http.diagNodeDTO": {
            "type": "object",
            "properties": {
                "ch_errors": {
                    "type": "integer"
        ...
        "internal_web_adapter_in_http.diagSourceDTO": {
            "type": "object",
            "properties": {
                "available": {
                    "type": "boolean"
        ...
        "internal_web_adapter_in_http.diagnosticsDTO": {
            "type": "object",
            "properties": {
                "clickhouse": {
                    "$ref": "#/definitions/internal_web_adapter_in_http.diagSourceDTO"
                },
                ...
                "nodes": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_web_adapter_in_http.diagNodeDTO"
                    }
                },
                "prometheus": {
                    "$ref": "#/definitions/internal_web_adapter_in_http.diagSourceDTO"
        ...
        "internal_web_adapter_in_http.headerRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "internal_web_adapter_in_http.headerResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "internal_web_adapter_in_http.hostPreviewRequest": {
            "type": "object",
            "properties": {
                "kind": {
                    "type": "string"
        ...
        "internal_web_adapter_in_http.hostRequest": {
            "type": "object",
            "properties": {
                "description": {
                    "type": "string"
        ...
        "internal_web_adapter_in_http.hostResponse": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "internal_web_adapter_in_http.overviewTotalsDTO": {
            "type": "object",
            "properties": {
                "error_rate": {
                    "type": "number"
        ...
        "internal_web_adapter_in_http.queueListDTO": {
            "type": "object",
            "properties": {
                "capped": {
                    "type": "boolean"
                ...
                "items": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_web_adapter_in_http.queueMessageDTO"
                    }
                },
                "kafka_available": {
                    "type": "boolean"
                },
                "original_window_hours": {
                    "description": "OriginalWindowHours — §96.7: сколько часов повтор записи узла ещё может\nотправить ПОЛНОЕ тело из конверта очереди. 0 — окно неизвестно (Kafka не\nсконфигурирована), интерфейс тогда срока не обещает.",
                    "type": "integer"
                }
            }
        },
        "internal_web_adapter_in_http.queueMessageDTO": {
            "type": "object",
            "properties": {
                "body_size": {
                    "type": "integer"
        ...
        "internal_web_adapter_in_http.queuePurgeDTO": {
            "type": "object",
            "properties": {
                "cancelled": {
                    "type": "integer"
        ...
        "internal_web_adapter_in_http.queuePurgeRequest": {
            "type": "object",
            "properties": {
                "from": {
                    "type": "string"
        ...
        "nexus_internal_domain.SchemaSyncPlan": {
            "type": "object",
            "properties": {
                "rejections": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/nexus_internal_domain.SchemaSyncRejection"
                    }
                },
                "statements": {
                    "type": "array",
        ...
        "nexus_internal_domain.SchemaSyncRejection": {
            "type": "object",
            "properties": {
                "current": {
                    "type": "string"
                ...
                "kind": {
                    "description": "engine | order_by | partition_by",
                    "type": "string"
                },
                "reason": {
                    "type": "string"
        ...
        "nexus_internal_domain.ServiceLogEntry": {
            "type": "object",
            "properties": {
                "attrs": {
                    "type": "object",
        ...
        "nexus_internal_web_usecase.ReplayResult": {
            ...
            "properties": {
                ...
                "body_source": {
                    "description": "BodySource — §96: откуда взято отправленное тело (queue | log | override).\nИнтерфейсу это нужно, чтобы не гадать, ушла ли полная копия запроса.",
                    "type": "string"
                },
                "duration_ms": {
                    "type": "integer"
        ...
        "nexus_internal_web_usecase.SchemaSyncResult": {
            "type": "object",
            "properties": {
                "applied": {
                    "description": "Applied — сколько ALTER'ов реально исполнено (только для Apply).",
                    "type": "integer"
                },
                "plan": {
                    "$ref": "#/definitions/nexus_internal_domain.SchemaSyncPlan"
                },
                "table": {
                    "type": "string"
                },
